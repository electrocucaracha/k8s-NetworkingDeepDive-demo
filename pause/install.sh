...
if ! command -v runc || [ "$(runc --version | awk 'NR==1{print $3}')" != "1.4.2" ]; then
    sudo curl -o /usr/bin/runc -L https://github.com/opencontainers/runc/releases/download/v1.4.2/runc.amd64
